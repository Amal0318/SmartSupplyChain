      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="hidden sm:inline">{user?.full_name ?? user?.email ?? 'User'}</span>
            <ChevronDown className="w-3.5 h-3.5 text-zinc-500" />
          </button>

          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-white border border-zinc-200 rounded-2xl shadow-xl p-2 z-50">
