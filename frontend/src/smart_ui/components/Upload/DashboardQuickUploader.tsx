...
export const DashboardQuickUploader: React.FC<DashboardQuickUploaderProps> = ({
  ...
  const handleFileProcess = async (file: File) => {
    ...
    try {
      ...
      setProgressText('Uploading to backend AI Agent...');
      ...
      const domainEndpointMap: Record<string, string> = {
        ...
        logistics: '/upload/procurement',
        master: '/upload/procurement',
      };

      const endpoint = domainEndpointMap[currentDomain] || '/upload/procurement';
